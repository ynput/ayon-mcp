...
FastMCP OpenAPI tools are currently not working with the OpenAPI spec
generated by AYON because of various validation issues.

This script acts as a workaround to generate the tools from
the spec and make them usable with FastMCP.
